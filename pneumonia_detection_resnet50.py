# -*- coding: utf-8 -*-
"""Pneumonia_detection_ResNet50

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EMM1jZD8Sm7r9hOoqnX8sHS088X5VPnN
"""
...
cd/gdrive/MyDrive/Pneumonia_detection/
...
train_generator = train_datagen.flow_from_directory(
    '/gdrive/MyDrive/Pneumonia_detection/',
    target_size=(224, 224),
    batch_size=32,
...
train_dataset = image_dataset_from_directory('/gdrive/MyDrive/Pneumonia_detection/',
                                             shuffle=True,
...
model.save('Pneumonia_detection_ResNet50.h5')